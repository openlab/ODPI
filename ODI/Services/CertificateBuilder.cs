...
namespace ODI.Service
{
    ...
    {
        private static string command = "-r -pe -a sha1 -n \"CN=ODI Certificate\" -ss My -len 2048 -sp \"Microsoft Enhanced RSA and AES Cryptographic Provider\" -sy 24 {0}\\oidcertificate.cer";
